    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route path='users/posts/' element={isLoggedIn ? <UsersPosts user={user} /> : <Navigate to='/users/login' />} />
                <Route path='/posts/add' element={isLoggedIn ? <AddPost user={user} /> : <Navigate to='/users/login' />} />
                <Route path='/users/login' element={isLoggedIn ? <Navigate to='/' /> : <UserLogin setIsLoggedIn={setIsLoggedIn} />} />
                <Route path='/users/register' element={<SignUp setIsLoggedIn={setIsLoggedIn} />} />
                <Route path='/users/:id' element={isLoggedIn ? <UserProfile user={user} /> : <Navigate to='/users/login' />} />
